...
TvSwapChain::TvSwapChain(TvDevice &deviceRef, VkExtent2D extent)
...
VkResult TvSwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult TvSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                           uint32_t *imageIndex) {
...
void TvSwapChain::createSwapChain() {
...
void TvSwapChain::createImageViews() {
...
void TvSwapChain::createRenderPass() {
...
void TvSwapChain::createFramebuffers() {
...
void TvSwapChain::createDepthResources() {
...
void TvSwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR TvSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR TvSwapChain::chooseSwapPresentMode(
...
VkExtent2D
TvSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat TvSwapChain::findDepthFormat() {
